/*
 * L10n :: Simple Chinese Pack
 * Copyright (C) 2011 LeanDev
...
public class SimpleChinesePackPluginTest {

  private static final String SONAR_VERSION = "2.11";

  @Test
  public void coreBundleShouldBeUpToDate() {
    assertThat("core_cn.properties", isBundleUpToDate(SONAR_VERSION));
  }

  @Test
  public void gwtBundleShouldBeUpToDate() {
    assertThat("gwt_cn.properties", isBundleUpToDate(SONAR_VERSION));
  }

  @Test
  public void squidJavaBundleShouldBeUpToDate() {
    assertThat("squidjava_cn.properties", isBundleUpToDate(SONAR_VERSION));
  }
